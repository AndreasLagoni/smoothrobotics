...
$output .= "\t" . '<div class="wpsl-search wpsl-clearfix custombg' . $this->get_css_classes() . '">' . "\r\n";
$output .= "\t\t" . '<div id="wpsl-search-wrap">' . "\r\n";
$output .= "\t\t\t" . '<form autocomplete="off" class="customdisplay">' . "\r\n";
$output .= "\t\t\t" . '<div class="customcanvas-header">' . "\r\n";
$output .= "\t\t\t\t" . '<h2>Find The Closest Distributors</h2>';
$output .= "\t\t\t" . '</div>' . "\r\n";
...
if ( $wpsl_settings['reset_map'] ) { 
    ...
    $output .= "\t\t" . '<div id="wpsl-gmap" class="wpsl-gmap-canvas customcanvas"></div>' . "\r\n";
    $output .= "\t" . '</div>' . "\r\n";
} else {
    $output .= "\t" . '<div id="wpsl-gmap" class="wpsl-gmap-canvas customcanvas"></div>' . "\r\n";
}
