...
<p class="newsbanner-p"><?php echo get_theme_mod('smoothrobotics-contact-callout-paragraph')?></p>
...
<section class="contact-wrapper">
    <article class="contact-info">
        <h2 class="contactinfo"><?php echo get_theme_mod('smoothrobotics-contact-callout-contenthead')?></h2>
    </article>
